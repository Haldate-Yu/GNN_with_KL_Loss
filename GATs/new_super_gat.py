...
from new_super_gat_layer import SuperGATConv
...
class Net(torch.nn.Module):
    def __init__(self, dataset):
        super().__init__()
        self.conv1 = SuperGATConv(dataset.num_features, args.hidden,
                                  heads=args.heads, dropout=args.dropout)
        self.conv2 = SuperGATConv(args.hidden * args.heads, dataset.num_classes,
...
model_name = 'new_super_gat_' + args.attention_type
logger(model_name=model_name, loss=loss, acc=acc, duration=duration, args=args)
